...
export const createGlobalStyles = (colors: ThemeColors) =>
  StyleSheet.create({
    ...
    title: { fontSize: 28, fontWeight: 'bold', color: colors.titleText, marginBottom: 16 },
    subtitle: { fontSize: 18, fontWeight: '600', color: colors.primaryDark, marginBottom: 8 },
    sectionLabel: {
      fontSize: 12,
      fontWeight: '700',
    ...
    text: { fontSize: 16, color: colors.bodyText },
    mutedText: { fontSize: 14, color: colors.mutedText },
    ...
    pillButtonText: { color: '#fff', fontWeight: '700', fontSize: 13 },
    ...
    inputFocused: { borderColor: colors.primaryDark, borderWidth: 2 },
    inputMultiline: {
      borderWidth: 1,
      borderColor: colors.border,
      borderRadius: 6,
